          ...
          <div>
            <nav className="navbar">
              <ul className="navbar-nav">
                <li className="nav-item" onClick={(e) => this.props.toggle(e, 'info')}>
                ...
                <li className="nav-item" onClick={(e)=> this.props.toggle(e, 'board')}>
                  <a href="#" className="nav-link">
                    <svg
                      id="Capa_1"
                      viewBox="0 0 512 512"
                ...
                <li className="nav-item" onClick={(e) => this.props.toggle(e, 'resource')}>
                  <a href="#" className="nav-link">
                    <svg
