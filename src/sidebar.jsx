              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <a href="#" className="nav-link">
                    ...
                    <span className="link-text" onClick={(e)=> this.props.toggle(e, 'board')}>Action Items</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link">
                    ...
                    <span className="link-text" onClick={(e) => this.props.toggle(e, 'resource')}>Resources</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link">
